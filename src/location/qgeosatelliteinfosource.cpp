...
/*!
    ...
    \ingroup location
        \headerfile qgeosatelliteinfosource.cpp <QtLocationSubset/QGeoSatelliteInfoSource>
    @xmlonly
    ...
    Users of a BB10 QGeoSatelliteInfoSource subclass (obtained from QGeoSatelliteInfoSource::createDefaultSource())
    can access the underlying backend (BB10 Location Manager) for additional functionality via the Qt property system.

    The following properties extend QGeoSatelliteInfoSource allowing use of additional features of the BB10 Location Manager.
    ...
    or requestUpdate().
        ...
        \property period
        \brief This property specifies the period of the satellite update request, in seconds. A value of '0' indicates a one-time
        update request.
        \code
        ...
        \brief This property specifies the desired response time of the update, in seconds. A value of '0' disables response
        time criteria.
        \code
...
#endif
    Q_FOREACH (QGeoPositionInfoSourceFactory *f, QGeoSatelliteInfoSourcePrivate::pluginsSorted()) {
