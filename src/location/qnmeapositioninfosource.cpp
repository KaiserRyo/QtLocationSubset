...
{
    m_lastUpdate = update;
    Q_EMIT m_source->positionUpdated(update);
}
...
/*!
    ...
    \ingroup location
        \headerfile qnmeapositioninfosource.cpp <QtLocationSubset/QNmeaPositionInfoSource>
    @xmlonly
