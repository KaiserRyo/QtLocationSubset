...
/*!
    ...
    \ingroup maps-impl
        \headerfile qgeosearchmanagerengine.cpp <QtLocationSubset/QGeoSearchManagerEngine>
    @xmlonly
    ...
    of QGeoSearchReply internally, in order to add any engine-specific
...
/*!
    ...
    \a searchTypes normally determines whether the search is for addresses only,
