...
/*!
    ...
    \ingroup maps-places
        \headerfile qgeosearchreply.cpp <QtLocationSubset/QGeoSearchReply>
    @xmlonly
...
/*!
    ...
    \value CombinationError
        An error occurred while results were being combined from multiple sources.
    \value UnknownError
...
/*!
    Returns true if the operation completed successfully or encountered an
    error which caused the operation to come to a halt.
*/
